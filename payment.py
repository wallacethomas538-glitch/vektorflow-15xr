...
def create_checkout(email: str, success_url: str, cancel_url: str, current_email: str = Depends(get_current_user)):
    if current_email != email:
        raise HTTPException(403, "You can only create checkout for yourself")
