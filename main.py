"""
VektorFlow 15xr - Final Main Entry Point
All phases combined: Langfuse, Gemini, ChromaDB, n8n, Whisper, Ollama
"""
...
from database import save_memory, get_all_memory, delete_memory, clear_all_memory, search_memory
init_db()
...
@app.get("/vektor/memory/search")
async def search_memory_endpoint(query: str, email: str = Depends(get_current_user)):
    results = search_memory(email, query)
